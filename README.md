...
1. Clone the code.
   ```shell
   git clone https://github.com/tidbcloud/smart-village.git
   cd smart-village
   ```
...
[![Deploy to Netlify button](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/tidbcloud/smart-village)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-name=smart-village&repository-url=https%3A%2F%2Fgithub.com%2Ftidbcloud%2Fsmart-village&env=DATABASE_URL&envDescription=TiDB%20Cloud%20connection%20string)
